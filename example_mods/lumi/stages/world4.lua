function onCreate()
    makeLuaSprite('bg', 'mod-bgs/world4/bg', -1200, -500)
    makeLuaSprite('floor', 'mod-bgs/world4/floor', -1200, -500)
    makeLuaSprite('speakers', 'mod-bgs/world4/speakers', -1340, -590)
    makeAnimatedLuaSprite('beat1', 'mod-bgs/beatAnim', 162, 734)
    makeAnimatedLuaSprite('beat2', 'mod-bgs/beatAnim', 394, 706)
    makeAnimatedLuaSprite('beat3', 'mod-bgs/beatAnim', 390, 500)
